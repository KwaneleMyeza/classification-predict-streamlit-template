...
def main():
    ...
    if selection == "Prediction":
        ...
        st.info("""\t News: the input links to factual news about climate change  
        \t Pro: the input supports the belief of man-made climate change  
        \t Neutral: the input neither supports nor refutes the belief of man-made climate change  
        \t Anti: the input does not believe in man-made climate change Variable definitions""")
